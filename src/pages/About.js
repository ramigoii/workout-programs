      ...
      <section className="about-content">
        <div className="about-text">
          ...
          <p>
            ...
            Наша цель — сделать фитнес доступным, эффективным и приятным для всех.
          </p>
          <button className="cta-button">Начать тренировки</button>
        </div>
        <div className="about-image">
          <img src={require("../styles/images/our-mission.jpg") || "/placeholder.svg"} alt="Наша миссия" />
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            <div className="value-item">
              ...
              <p>Мы создаем программы, доступные каждому, независимо от уровня подготовки.</p>
            </div>
            <div className="value-item">
              <div className="value-icon">
                <FaGraduationCap />
              ...
              <p>Все наши тренировки разработаны сертифицированными экспертами в области фитнеса.</p>
            </div>
            <div className="value-item">
              <div className="value-icon">
                <FaHandsHelping />
              ...
              <h3>Сообщество</h3>
              <p>Мы создаем дружественную среду, где участники поддерживают и мотивируют друг друга.</p>
            </div>
          </div>
        </div>
      </section>
